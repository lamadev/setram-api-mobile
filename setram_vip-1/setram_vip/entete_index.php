...
<nav class="navbar navbar-findcond navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbar">
			<ul class="nav navbar-nav">
                ...
                <li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="Rapport_Global.php?Type=envoi"><i class="fa fa-fw fa-thumbs-o-up"></i>Depots</a></li>
                        <li><a href="Rapport_Global.php?Type=retrait"><i class="fa fa-fw fa-tag"></i>Retraits</a></li>
                        <li><a href="Rapport_Global.php?Type=envoi"><i class="fa fa-fw fa-thumbs-o-up"></i>Transferts</a></li>
            ...
            <div id="Utilisateur" class="nav navbar-nav" style="padding-left:5em;">
            	<div style="padding-top:15px; color:#ffffff;">Remy NGOY : Operateur</div>
