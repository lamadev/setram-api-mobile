    				...
    				<div class="panel panel-default" >
    					<table class="table table-striped table-condensed">
    						<div class="panel-heading" id="agences">
	    						<h5 class="panel-title" id="TitlPanel">Tarification transactions</h5>
    						</div>
    						<tbody>
    							<?php
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<div class="panel-body">
										<table class="table">
											...
											<tr>
												<td>
													<a href="compte_num.php?ident='dep'">Depot</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="compte_num.php?ident='retr'">Retrait</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="compte_num.php?ident='transf'">Transfert</a>
