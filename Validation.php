<?php 
  ...
  include("codes/controles/ControleRetour.php");
  ...
  <?php require_once("Entete.php");?>
    ...
    <div class="container">
              <div class=" col-md-9" style="text-align:justify;">
                    <div class="row">
                          <h2 style="color:#FFF;">Validation</h2>
                        </div>
            <div class="row well">
                            <div class="col-sm-8 col-lg-8" style="color:#000000">
                                ...
                                <div class="row" style="padding-top:100px;">
                                  <form method="POST" enctype="multipart/form-data">
                                    <div class="col-md-4">
                                      <button class="btn btn-primary" name="retour" style="font-size:14ppx;">
                                        Retour
                                      </button>
                                    </div>
                                    <!--<div class="col-md-4">
                            ...
                            <div class="col-sm-4 col-lg-4">
                                <img src="fichier/site/image/validation.png" alt="Confirmation" width="200" height="178" class="img-rounded" />
                            </div>
                       </div>
                </div>
