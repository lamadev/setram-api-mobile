								...
								<div id="collapseTwo" class="panel-collapse collapse">
									<div class="panel-body">
										<table class="table">
											<tr>
												<td>
													<a href="FinancementAdm.php">Financement</a>
												</td>
											</tr>
								...
								<div id="collapseThree" class="panel-collapse collapse">
									<div class="panel-body">
										<table class="table">
											<tr>
												<td>
													<a href="RapportGlob_Adm.php?Type=admin">Global</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="RapportDepot_Glob.php?Type=depot">Depot</a> 
												</td>
											</tr>
											<tr>
												<td>
													<a href="RapportRetrait_Glob.php?Type=retrait">Retrait</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="RapportTransfert_Glob.php?Type=transfert">Transfert</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="RapportConversion_Glob.php?Type=conversion" >Conversion</a>
												</td>
											</tr>
                                            
                                            <tr>
												<td>
													<a href="RapportDepense_Glob.php?Type=depense">Depenses</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="RapportFinance_Glob.php?Type=financement" >Financements</a>
												</td>
											</tr>
										</table>
									</div>
    				...
    				<div class="panel panel-default" >
    					<table class="table table-striped table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								<td>
    									<a href="RecherchCompteAdm.php" style="color:#000000"><li class="list-group-item list-group-item-warning">Gérer Comptes Clients</li></a>
    								</td>
    							</tr>
    							<!--<tr>
    								<td>
