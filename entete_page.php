			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="FinancementAdm.php"><i class="fa fa-fw fa-thumbs-o-up"></i>Financer une agence</a></li>
                        <li>
                        	<?php
                ...
                <li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="RapportGlob_Adm.php?Type=admin"><i class="fa fa-fw fa-tag"></i>Global</a></li>
						<li><a href="RapportDepot_Glob.php?Type=depot"><i class="fa fa-fw fa-thumbs-o-up"></i>Depot</a></li>
                        <li><a href="RapportRetrait_Glob.php?Type=retrait"><i class="fa fa-fw fa-tag"></i>Retraits</a></li>
                        <li><a href="RapportTransfert_Glob.php?Type=transfert"><i class="fa fa-fw fa-thumbs-o-up"></i>Transfert</a></li>
						<li><a href="RapportDepense_Glob.php?Type=depense"><i class="fa fa-fw fa-thumbs-o-up"></i>Depenses</a></li>
                        <li><a href="RapportFinance_Glob.php?Type=financement"><i class="fa fa-fw fa-thumbs-o-up"></i>Financement</a></li>
                        <li><a href="RapportConversion_Glob.php?Type=conversion"><i class="fa fa-fw fa-thumbs-o-up"></i>Conversion</a></li>
					</ul>
				</li>
