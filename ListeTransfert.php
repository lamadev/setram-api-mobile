...
include("codes/controles/ControleList_Transfert.php");
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div class="container">
    	<div class="col-md-12" style="padding-top:50px;">
    		<div class="row well" id="Paneau">
    			<div id="agences" >
	                <h2 style="text-align:center">  Liste des Transferts du <?php echo $Periode; ?></h2>
                                         ...
                                         <div class="panel-body">
                                           ...
                                           <thead>
                                               ...
                                               <tr>
                                                  <th>Date </th>
                                                  <th>Montant</th>
                                                  <th>Moyen op&eacute;ré</th>
                                                  <th>Frais Transfert</th>
                                                  <th>Frais Sms</th>
                                                  <th>Compte Expedié</th>
                                                  <th>Compte Beneficie</th>
