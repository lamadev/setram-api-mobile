...
//include("codes/controles/ControleRapportConversion.php");
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div class="container">
        <div class="col-md-12" style="padding-top:50px;">
            <div class="row well" id="Paneau">
                <div id="agences" >
                    <h3 style="text-align:center">  Rapport Conversion </h3>
                     ...
                     <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th>
                              <button id="BtnEnvoye" type="button"class="btn btn-default" style="color:#f90101; font-weight:700">Valider</button>
                            </th>
                          </tr>
                        </thead>
                      </table>
