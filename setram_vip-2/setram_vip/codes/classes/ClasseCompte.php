...
class Compte {
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				  ...
				  function fx_ModiferSoldCompte_Setram($Solde,$CodeMonnaie,$CodeTypeCompte){
                               
					  	       $this->solde=$Solde;
				  	           $requete="update compteb set Solde='".$this->solde."' where compteb.CodeTypeCompte='".$CodeTypeCompte."' AND CodeMonnaie='".$CodeMonnaie."'  limit 1";
				               //echo $requete;
				               $conn=new connect();// preperation de la conexion (extentier)
		                       $resultat=$conn-> fx_modifier($requete);
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				  ...
				  function fx_ModiferSolde_Compte($NumCompte,$Solde,$CodeMonnaie){
                               
					  	       $this->solde=$Solde;
				  	           $requete="update compteb set Solde='".$this->solde."' where compteb.NumCompte='".$NumCompte."' AND CodeMonnaie='".$CodeMonnaie."'  limit 1";
				               //echo $requete;
				               $conn=new connect();// preperation de la conexion (extentier)
		                       $resultat=$conn-> fx_modifier($requete);
			...
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				  function fx_RechecheCompte($NumCompte) {
							$requete = "select * from compteb,typecompte,monnaie,client where compteb.NumCompte='".$NumCompte."' AND client.IdClient=compteb.IdClient AND monnaie.CodeMonnaie=compteb.CodeMonnaie AND compteb.CodeTypeCompte=typecompte.CodeTypeCompte AND EtatCompteB=1";
							//echo $requete;
							$conn=new connect();
							$Resultat=$conn->fx_lecture($requete);
							if (!$Resultat){
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
				  function fx_GestionCompte(){
							  $requete="select * from client,compteb,typecompte, monnaie where compteb.CodeMonnaie=monnaie.CodeMonnaie AND client.IdClient=compteb.IdClient AND compteb.CodeTypeCompte=typecompte.CodeTypeCompte order by compteb.CodeMonnaie";
							  //echo $requete; 
							  $conn=new connect();// preperation de la conexion
							  $resultat=$conn-> fx_lecture($requete);
									if ($resultat){
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////// 
				  function fx_RechercheCompte_Num($NumCompte){
							  $requete="select * from client,compteb,typecompte, monnaie where compteb.CodeMonnaie=monnaie.CodeMonnaie AND client.IdClient=compteb.IdClient AND compteb.CodeTypeCompte=typecompte.CodeTypeCompte AND compteb.NumCompte='".$NumCompte."' order by compteb.CodeMonnaie";
							  //echo $requete; 
							  $conn=new connect();// preperation de la conexion
							  $resultat=$conn-> fx_lecture($requete);
									if ($resultat){
