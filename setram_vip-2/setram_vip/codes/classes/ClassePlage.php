...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function fx_trouve_plage($Montant,$CodeMonnaie){
			$requete="SELECT plage.IdPlage,plage.TypePlage,plage.CodeMonnaie,plage.MonntantPlage,monnaie.CodeMonnaie,monnaie.Libmonnaie,plage.IdFrais FROM plage,monnaie WHERE plage.CodeMonnaie=monnaie.CodeMonnaie AND ((plage.BorneInf<='".$Montant."' And plage.BornSuper>='".$Montant."')or(plage.BorneInf<='".$Montant."' And plage.BornSuper=0)) And plage.CodeMonnaie='".$CodeMonnaie."' And plage.EtatPlage=1";
				//echo $requete;	
