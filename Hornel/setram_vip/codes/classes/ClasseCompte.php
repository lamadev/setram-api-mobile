...
class Compte {
			...
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				function fx_login_mobile($phone,$pin){


				$query_get_info="SELECT beneficiairy.Nom AS name, beneficiairy.postnom AS lastname,beneficiairy.sexe AS sex,beneficiairy.phone AS numberphone,account.NumCompte AS accountNum, account.solde AS balance,type_monney.libmonnaie AS currency,account.IdCompte AS IdCompte FROM compteb AS account JOIN securite AS security ".
                "ON account.IdCompte=security.IdCompte JOIN monnaie AS type_monney ON account.CodeMonnaie=type_monney.CodeMonnaie JOIN client AS beneficiairy ON account.IdClient=beneficiairy.IdClient WHERE security.PIN=:pin AND beneficiairy.phone=:phone";
                	$arrayLog=array
                	(
                		"pin"=>$pin
                	);
						$conn=new connect();
						return $conn->fx_logger_client($query_get_info,$arrayLog);
