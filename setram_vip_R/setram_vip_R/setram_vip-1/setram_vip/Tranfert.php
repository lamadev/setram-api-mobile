    			...
    			<div class="col-md-6" style="padding-top:50px;">
    				<form action="" method="post">
    					<div class="row" style="padding-top:50px;">
							...
							<div class="col-md-7">
								<input name="nomag" type="text" class="form-control" id="text" placeholder="Montant à transferer" />
							</div>
							</div>
							<br /><br />
							<div class="form-group">
								<label for="text" class="col-md-4">Frais :</label>
							<div class="col-md-7">
								<label style="color:#f14444;">10 USD</label>
							</div>
							</div>
						</div>
						<div class="row" style="padding-top:10px;">
							...
							<div class="col-md-7">
								<input name="nomag" type="text" class="form-control" id="text" placeholder="Num&eacute;ro Compte" />
							</div>
							</div>
						</div>
						<br /><br />
