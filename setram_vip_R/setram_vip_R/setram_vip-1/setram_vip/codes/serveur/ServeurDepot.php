<?php 
	...
	if($CodeTypeTransact==''){
	 ...
	 if($Formulaire_Valide == true)
	 {
		  ...
		  $resultat_E=$RecheEtab->fx_creertransaction($MontantTransact,$CodeMonnaie,"E",$MoyenTransact,$CodeTypeTransact,$IdCompte_E,"",1);
						...
						echo "{\"groupeAll\":[";
							while ($row = $resultat->fetch()) {
								if ($debut){
									...
									if ($j==0)$colonne='Depot effectue avec succes';
