...
class Agent {
		    	  ...
		    	  function fx_Authentification($Login, $Mdp) {
								...
								$this->Mdp=$Mdp; 
								if (empty($Login)) {
								return FALSE ;} // Pas de Login vide
								if (empty($Mdp)) {
					 ...
					 function fx_Agence_de_Agent($idagent){
					  $requete="select affecter.idagent,agence.IdAgence,agence.NomAgence,agence.EtatAgence
								from affecter,agence
								where affecter.idagence=agence.idagence
								AND (EtatAgence=1 or EtatAgence=2)
								AND affecter.idagent=".$idagent."
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	  
				 function fx_Changer_EtatAgent($IdAgent,$EtatAg){

						        $requete="UPDATE agent SET EtatAg='".$EtatAg."' WHERE agent.IdAgent = '".$IdAgent."' LIMIT 1";
								//echo $requete;
								$conn=new connect();// preperation de la conexion
								$Resultat=$conn-> fx_modifier($requete);
			...
			////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				   ...
				   function fx_List_Gen_Agent(){
							...
							$requete="select * from affecter,agent,agence,typeagent where agent.CodeTypeAgent=typeagent.CodetypeAgent AND affecter.IdAgence=agence.IdAgence AND affecter.IdAgent=agent.IdAgent AND affecter.EtatAffecter=1 order by agent.IdAgent";
				  ...
				  function fx_TypeAgent(){

							$requete="select * from typeagent ";
			...
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                  ...
                  function fx_ListGenAgent_Agence($IdAgent){
							...
							where affecter.IdAgent='".$IdAgent."'
