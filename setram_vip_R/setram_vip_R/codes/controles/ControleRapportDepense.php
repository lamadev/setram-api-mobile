...
if (isset($_POST['Envoyer'])) {
	...
	$Tab_Mouv=$recherche->fx_DepenseAgc_Date($_SESSION['IdAgence'],$_POST['Cdatee'],$_POST['Cdate']);
	$Tab_Rubrik=$recherche->fx_DepenseAgc_Sum($_SESSION['IdAgence'],$_POST['Cdatee'],$_POST['Cdate']);
}else {
	$DateAff=date($Format_Affiche,strtotime($Cdate));
	$Tab_Mouv=$recherche->fx_DepenseAgc_Jour($_SESSION['IdAgence'],$Aj);
	$Tab_Rubrik=$recherche->fx_DepenseAgc_SumJr($_SESSION['IdAgence'],$Aj);
}
