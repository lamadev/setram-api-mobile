    ...
    <div class="container">
        <div class="col-md-12" style="padding-top:50px;">
            <div class="row well" id="Paneau">
                <div id="agences" >
                    <h3 style="text-align:center">  Liste Depots </h3>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>                       
                        ...
                        <?php 
                          echo'<a href="EtatGen.php?idTrans='.$data['IdTransact'].'&etat=0&Type=depot" class=" badge bg-primary">Desactiver</a>';
                        ?>                                                                                     
                        <?php                           
                        }else{
                        ?>                          
                        <?php 
                          echo'<a href="EtatGen.php?idTrans='.$data['IdTransact'].'&etat=1&Type=depot" class=" badge bg-primary">Activer</a>';
                        ?>
