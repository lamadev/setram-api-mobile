...
if(isset($_POST['RechercheJ'])){
	...
	if($_POST['agenceExp']!= 0 && $_POST['Cdate']!= "" ){
		...
		$resultat=$reche_Agences->fx_DepotAgenc_Date($_POST['agenceExp'],$Cdate,"Depot");
		...
		$resultat=$recherche->fx_ListeGenDepot_Date($_POST['Cdate'],"Depot");
	}
$Etat=1;	
		...
		$resultat=$recherche->fx_ListeGenDepot_Date($Cdates,"Depot");
}
...
if(isset($_POST['RechercheM'])){
		...
		if($_POST['agenceExp']!= 0 && $_POST['mois']!= 0 && $_POST['annee']!= 0){
					...
					$Cannee=$_POST['annee'];
						$reche_Agences=new transaction();
						$resultat=$reche_Agences->fx_AffichageTransfertAgence_Mensuel($_POST['agenceExp'],$_POST['mois'],$_POST['annee'],"Depot");
					$Etat=2;
					$Periode=" de ".$Cmois."/".$Cannee;	
			}elseif($_POST['agenceExp']== 0 && $_POST['mois']!= 0 && $_POST['annee']!= 0){
					$Periode=" de ".$_POST['mois']."/".$_POST['annee'];	
					$recherche=new transaction();
					$resultat=$recherche->fx_AffichageTransfert_Mensuel($_POST['mois'],$_POST['annee'],"Depot");
