...
include("codes/controles/Controle_JournalDepot.php");
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div class="container">
    	<div class="col-md-12" style="padding-top:50px;">
    		<div class="row well" id="Paneau">
    			<div id="agences" >
	                <h2 style="text-align:center">  Journal depots </h2>
	                <span style="padding-left:10px;"><a href="Depot_Mount.php" class="badge bg-primary" style="background-color: #ffffff; color:#f14444;">Retour</a></span>
	            </div>
