    ...
    <div class="container">
    	<div class="col-md-12" style="padding-top:50px;">
    		<div class="row well" id="Paneau">
    				...
    				<div class="panel panel-default" >
    					<table class="table table-striped table-condensed">
    						<div class="panel-heading" id="agences">
	    						<h5 class="panel-title" id="TitlPanel">Tarification </h5>
    						</div>
    						<tbody>
    							<?php
											
                                 while($data=$Result_Tarif->fetch()){
								?>
    							<tr>
    								<td>
    									<?php
    									echo "De"." "." ".$data['BorneInf']." "."à"." "." ".$data['BornSuper']." "." ".$data['Libmonnaie'];
    									?>
    								</td>
    								<td>
    									<?php
    									echo $data['MonntantPlage']." "." ".$data['Libmonnaie'];
    									?>
    								</td>
    							</tr>
    			...
    			<div class="col-md-4" style="padding-top:50px;">
    				<img src="fichier/site/image/LogoSetram.png" class="img-responsive" width="500" align="center" />
    			</div>
    			<div class="col-md-4" style="padding-top:50px;">
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<div class="panel-body">
										<table class="table">
											<tr>
												<td>
													<a href="compte_num.php">Num&eacute;ro Compte Client</a>
												</td>
											</tr>
											<!--
											<tr>
											...
											<tr>
												<td>
													<a href="Num_Retrait.php?">Retrait</a>
												</td>
											</tr>
											<tr>
												<td>
													<a href="Num_Transfert.php">Transfert</a>
								...
								<div id="collapseTwo" class="panel-collapse collapse">
									<div class="panel-body">
										<table class="table">
											...
											<tr>
												<td>
													<a href="Financement.php">Conversion</a>
												</td>
											</tr>
											<tr>
												<td>
