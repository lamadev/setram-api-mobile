...
include_once("codes/controles/ControleNumCompte.php");
?>
<!DOCTYPE html>
<html lang="fr">
    				...
    				<form action="" method="post">
    					<div class="row" style="padding-top:150px;">
							...
							<div class="col-md-7">
								...
								<?php
                                    if(isset($MsgNumCompte)){
                                        echo '<p class="help-block">* '.$MsgNumCompte.'</p>';
                                    } 
                                ?> 
							</div>
							</div>
						...
						<div class="btn-group pull-right" style="padding-top:10px;padding-bottom:10px;padding-right:50px">
		                	<input type="submit" name="Envoyer" class="form-control" value="Envoyer" id="BtnEnvoye" />
		                </div>
    				</form>
    			</div>
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<div class="panel-body">
										<table class="table">
											<tr>
												<td>
													<a href="#">Num&eacute;ro Compte Client</a>
												</td>
											</tr>
											<!--
											<tr>
